...
function CourseCard({data}) {
    ...
    return (
        <div
            ...
            className="text-white w-[22rem] h-[430px] flex flex-col justify-center items-center  shadow-[0_0_10px_black] rounded-lg cursor-pointer group overflow-hidden bg-richblack-700"
        >
