...
function AddLecture() {
    ...
    async function onFormSubmit(e) {
        ...
        const response = await dispatch(addCourseLecture({userInput,token,id}));
        console.log("response at addlecture side........")
    ...
    useEffect(() => {
       ...
       else console.log(courseDetails)
       document.title="Add-Lecture";
    }, [])

    return (
        <HomeLayout>
            <div className="min-h-[90vh] text-white flex flex-col items-center justify-center gap-10  bg-richblack-800">
                <div className="flex flex-col gap-5 p-2 shadow-[0_0_10px_black] w-96 rounded-lg">
                    ...
                    >
                        ...
                        <button type="submit" className="py-1 bg-pink-400 font-semibold text-lg">
                            Add new Lecture
                        </button>
                    </form>
                </div>
